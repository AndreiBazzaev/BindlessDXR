...
void main(uint3 DTid : SV_DispatchThreadID)
{
    ...
    neighbours[0] = inputTexture.Load(coords[0]);
    neighbours[1] = inputTexture.Load(coords[1]);
    neighbours[2] = inputTexture.Load(coords[2]);
    neighbours[3] = inputTexture.Load(coords[3]);
